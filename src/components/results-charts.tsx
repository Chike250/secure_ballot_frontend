...
export function ResultsCharts({ type, data, selectedCandidate, onSelectCandidate, isLoading = false }: ChartProps) {
  ...
  // Optimize the handlePieClick function with useCallback
  ...
  // Optimize the updateDimensions function with useCallback
